...
public class CheckDialogFragment2 extends AlertDialogFragment2<CheckDialogFragment2> {
    ...
    public CheckDialogFragment2 setCheckTitle(String checkTitle) {
        this.checkTitle = checkTitle;
        return this;
    }

    public CheckDialogFragment2 setCheckTitleColor(int color) {
        this.mTitleColor = color;
        return this;
    }

    public CheckDialogFragment2 setCheckTitleSize(int size) {
        this.mTitleSize = size;
        return this;
    }

    public CheckDialogFragment2 setChecked(boolean checked) {
        isChecked = checked;
        return this;
    }

    public CheckDialogFragment2 setOnCheckedChangeListener(ZCheckBox.OnCheckedChangeListener onCheckedChangeListener) {
